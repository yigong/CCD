warning off
base_dir = '/Users/Yigong/Research/photon_diagnostics/data/08_08_14_background/median_subtracted/'
base_dir = './'
flist = dir([base_dir, 'image_10*.mat']);
...
for i = 1: num_file
    ...
    load(fullfile(base_dir, dirlist{i}, flist(i).name));
    
    [T, E] = CCDsegment4(img, 6, 'Mode', 'precal');
...
save('./all_tracks.mat', 'energy', 'tracks', '-v7.3')
