...
:fRunAction(run)
{
  ...
  SaveFilenameBaseCmd->SetGuidance("Default = /Users/amycoffer/Dropbox/Uni_Research/ETI/ETCI/simulation/acoffer_g4work/CCD_Tracking/temp_data");
  SaveFilenameBaseCmd->SetParameterName("SaveFilenameDir", false);
  SaveFilenameBaseCmd->SetDefaultValue("/Users/amycoffer/Dropbox/Uni_Research/ETI/ETCI/simulation/acoffer_g4work/CCD_Tracking/temp_data/");
