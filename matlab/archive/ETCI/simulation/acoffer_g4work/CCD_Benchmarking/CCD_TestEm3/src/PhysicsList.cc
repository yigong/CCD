...
PhysicsList::PhysicsList() : G4VModularPhysicsList()
{
  ...
  fCurrentDefaultCut   = 1.0*cm;
  fCutForGamma         = 1.0*mm; //fCurrentDefaultCut;
  fCutForElectron      = fCurrentDefaultCut;
  fCutForPositron      = fCurrentDefaultCut;
  // CCD 'Calor' Cut Values
  fProductionCutForCalor = 0.10*um; // Producion Cut for CCD
  regName = "Layer-A";
  fRangeCutForCalor = 0.10*um; // Range Cut for Region
...
{      
  ...
  //SetCutsWithDefault();  // --> Can be 'Turned on to Set Cuts Back to defaults (1mm)
    ...
    //Particle Cuts
    //SetParticleCuts
    SetCutsForRegion(fRangeCutForCalor,regName);
