function [D] = DiffuseTrack7(varargin)
%function [D] = DiffuseTrack7(psft, mode, inputdata)
%function [D] = DiffuseTrack7(psft, mode, inputdata, argname, argvalue, ...)
%function [D] = DiffuseTrack7(psft, mode, inputdata, argflagname, ...)
%
% New in DiffuseTrack7:
