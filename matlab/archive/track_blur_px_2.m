...
eval(str);
for pxsize = 2.5
% irradiating pixelplane
    for angle = 10:5:40
        ['irradiating from ','pixel plane at angle = ', num2str(angle), ...
        ...
        for i = 1
            try
                ...
                D = DiffuseTrack7(psft, 'manual', [pos_in, dE], 'depthcoordinates', [-0.65, 0], 'pixelsize', pxsize);
                D.rotate = phi;
                D.shift = [randx, randy];
        ...
        trackName = ['ePar', num2str(angle), 'tracks_px_', pxsizename,'.mat']
