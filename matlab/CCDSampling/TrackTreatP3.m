function [alphaO,phiO,dEO,hw]=TrackTreatP3(in,NTT,n)
...
nh=ceil(NL/NTT);
if n<NTT
in=in(startpositions((n-1)*nh+1):startpositions(nh*n)-1,:);
else
...
parfor i=1:NP
    ...
    pause(2); %pause for 2s to ensure random#sead in runF is randomized
end
for i=1:NP
