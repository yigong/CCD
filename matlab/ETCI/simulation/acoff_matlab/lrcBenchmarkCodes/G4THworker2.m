function G4THworker2(loadDataPath,flist,savepath,savepre,loadpre,loadsuf,savesuf,noise,pixelSize,pixelNoiseMatrix,i,placeholdersuf,psft,depthCordinates)
...
%batches of 5000, then save off
%batchsize = 1000;
batchsize = 5000; % Smaller output for single noise and single pixel size. 
