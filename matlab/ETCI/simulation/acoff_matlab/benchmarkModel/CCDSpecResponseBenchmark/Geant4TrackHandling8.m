 function currentOut = Geant4TrackHandling8(varargin)
...
%       14: Delta Energy (Along step)(neg)  (eV) (obsolet Geant4 Value)
...
%shortcuts to column numbers
    ...
    indEdep = 16;   % New to uses instead of (FinalE-InitE) or dE...
    ingLayerID = 17;
