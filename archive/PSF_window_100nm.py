...
currentDir = getcwd()
dataDir = '/global/scratch/ygzhang/G4BeamDiag/step_size/out_LRC/100nm/fits_pixelP'
chdir(dataDir)
Files = glob('*.mat')
numTracks = len(Files)
...
dump([xWindow, alphaT, alphaM, betaM, xT, yT, xM, yM, ET, EM], open('../PSF_window_100nm.p', 'wb'))
